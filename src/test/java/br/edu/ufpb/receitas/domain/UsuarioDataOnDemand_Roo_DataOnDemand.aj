...
import br.edu.ufpb.receitas.domain.UsuarioDataOnDemand;
...
privileged aspect UsuarioDataOnDemand_Roo_DataOnDemand {
    ...
    @Autowired
    UsuarioService UsuarioDataOnDemand.usuarioService;
    
    @Autowired
    UsuarioDAO UsuarioDataOnDemand.usuarioDAO;
    ...
    public void UsuarioDataOnDemand.setFotos(Usuario obj, int index) {
        String fotos = "fotos_" + index;
        obj.setFotos(fotos);
    }
